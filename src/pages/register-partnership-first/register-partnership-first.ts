...
@IonicPage()
@Component({
  selector: 'page-register-partnership-first',
  templateUrl: 'register-partnership-first.html',
})
export class RegisterPartnershipFirstPage {
  applicant : FormGroup;
  title:any;
  dobdate:any ;
  mark  = [
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad RegisterPartnershipFirstPage');
  ...
  applicantForm()
  {
    ...
    this.navCtrl.push('RegisterPartnershipSecondPage',{name:this.navParams.data.name});
  }
}
