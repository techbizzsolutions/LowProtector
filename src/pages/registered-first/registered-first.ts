...
@IonicPage()
@Component({
  selector: 'page-registered-first',
  templateUrl: 'registered-first.html',
})
export class RegisteredFirstPage {
  applicant : FormGroup;
  title:any;
  dobdate:any ;
  mark  = [
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad RegisteredFirstPage',this.navParams.data);
    this.title = this.navParams.data.name + " part 1";
  }
  ...
  applicantForm()
  {
   ...
   // this.applicant.value.dob = this.dobdate;
    ...
    localStorage.setItem('part1', JSON.stringify(this.applicant.value));    this.navCtrl.push('RegisteredSecondPage',{name:this.navParams.data.name});
  }
