...
@IonicPage()
@Component({
  selector: 'page-huf-first',
  templateUrl: 'huf-first.html',
})
export class HufFirstPage {
  applicant : FormGroup;
  dobdate:any ;
  mark  = [
    {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad HufFirstPage');
  }
  ...
  applicantForm()
  {
   ...
   // this.applicant.value.dob = this.dobdate;
    ...
    localStorage.setItem('part1', JSON.stringify(this.applicant.value));    this.navCtrl.push('HufSecondPage');
  }
}
