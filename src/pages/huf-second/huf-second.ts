...
@IonicPage()
@Component({
  selector: 'page-huf-second',
  templateUrl: 'huf-second.html',
})
export class HufSecondPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad HufSecondPage');
  }
  ...
  applicantForm()
  {
    ...
    this.navCtrl.push('PaymentPage',{name:'H.U.F.'});
    ...
    // this.senddata("H.U.F. Part1: " + JSON.stringify(part1) + " H.U.F. Part2: " +JSON.stringify(this.applicant.value));
