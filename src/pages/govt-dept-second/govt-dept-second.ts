...
@IonicPage()
@Component({
  selector: 'page-govt-dept-second',
  templateUrl: 'govt-dept-second.html',
})
export class GovtDeptSecondPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad GovtDeptSecondPage');
  }
  applicantForm()
  {
     var check = false;
    ...
    this.navCtrl.push('PaymentPage',{name:'Govt. Dept.'});
    ...
    // this.senddata("Govt. Dept. Part1: " + JSON.stringify(part1) + " Govt. Dept. Part2: " +JSON.stringify(this.applicant.value));
