...
@IonicPage()
@Component({
  selector: 'page-govt-dept-first',
  templateUrl: 'govt-dept-first.html',
})
export class GovtDeptFirstPage {
  applicant : FormGroup;
  dobdate:any ;
  mark  = [
    {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad GovtDeptFirstPage');
  }
  ...
  applicantForm()
  {
   ...
   // this.applicant.value.dob = this.dobdate;
    ...
    this.navCtrl.push('GovtDeptSecondPage');
  }
