...
@IonicPage()
@Component({
  selector: 'page-propritorship-second',
  templateUrl: 'propritorship-second.html',
})
export class PropritorshipSecondPage {
  applicant : FormGroup;
  dobdate:any ;
  Trade  = [
    {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad PropritorshipSecondPage');
  }
  ...
  applicantForm()
  {
    ...
    this.navCtrl.push('PaymentPage',{name:'Proprietorship'});
    ...
    // this.senddata("Propritorship Part1: " + JSON.stringify(part1) + " Propritorship Part2: " +JSON.stringify(this.applicant.value));
