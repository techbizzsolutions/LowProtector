...
@IonicPage()
@Component({
  selector: 'page-applicant-second',
  templateUrl: 'applicant-second.html',
})
export class ApplicantSecondPage {
  applicant : FormGroup;dobdate:any ;
  Trade  = [
    {
      title: 'Manufactures',
      selected: false
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ApplicantSecondPage');
  }
  ...
  applicantForm()
  {
    ...
    this.navCtrl.push('PaymentPage',{name:'Applicant'});
    ...
    // this.senddata("Applicant Part1: " + JSON.stringify(part1) + " Applicant Part2: " +JSON.stringify(this.applicant.value));
